...
class Admin_ContactController extends Zend_Controller_Action {
    ...
    var $actions = array(
        array('type' => 'link', 'label' => 'Editar datos de contacto', 'icon' => 'edit', 'controller' => 'contact', 'action' => 'edit')
    );
    var $options = array(
    ...
    public function init() {
        ...
        $this->view->currentBrand = 'Página de Contacto';
    ...
    public function indexAction() {
        $this->_redirect('admin/contact/edit/id/1');
    }
    ...
    public function editAction() {
        if ($this->getRequest()->isPost()) {
            try {
                $arrayUpdate = array(
                    ...
                    'CFooter' => ($_POST["CFooter"]),'CFooterEn' => ($_POST["CFooterEn"])
                );
        ...
        $this->view->title = 'Editar datos de contacto';
        $this->view->description = 'Por favor ingrese los datos de Contacto';
